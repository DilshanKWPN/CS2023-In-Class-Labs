...
struct HashTable {
    ...
    int hashfunc(string user_name) {
        ...
        for (int i = 0; i < user_name.size(); i++) {
            sum = sum + user_name[i];//adding ascii value of each character
        }
    ...
    void insert(string user_name, string user_password) {
        ...
        if (empty) {
            ...
            cout << "User is inserted\n";
        }
        else {
            cout << "Slot is already filled,delete the previous user and try again.";
        }
    ...
    void hash_lookup(string user_name) {
        ...
        if (!empty) {
            cout << user_name << " 's" << " password is " << password[hash] << endl;
        }
        else {
            cout << "User name invalid!\n";
        }
